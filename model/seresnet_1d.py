...
class SE_Block(nn.Module):
    expansion = 1
    def __init__(self, in_channels, out_channels, i_downsample=None, stride=1, reduction=16):
    ...
    def forward(self, x):
        ...
        out = self.dropout(self.batch_norm2(self.conv2(out)))
...
class SeResnet(nn.Module):
    def __init__(self, ResBlock, layer_list, num_classes=9, num_channels=12):
        ...
        self.conv1 = nn.Conv1d(num_channels, 64, kernel_size=15, stride=3, padding=7, bias=False)
...
def se_resnet18(num_classes=9, channels=12):
    return SeResnet(SE_Block, [2,2,2,2], num_classes, channels)

def se_resnet34(num_classes=9, channels=12):
    return SeResnet(SE_Block, [3,4,6,3], num_classes, channels)   
